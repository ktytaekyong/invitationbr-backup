          ...
          <CommonItemWrapper key={`${item.title}${idx}`}>
            ...
            <CommonItemContent title='사진' multi={true}>
              ...
              <RadioList title='사진 위치'>
                <RadioItem radioName='noticePhotoTPosition' id='noticePhotoIntro' content='본문 위쪽' defaultChecked={true}></RadioItem>
                <RadioItem radioName='noticePhotoTPosition' id='noticePhotoAll' content='본문 아래쪽'></RadioItem>
              </RadioList>
            </CommonItemContent>
          </CommonItemWrapper>
        ))}
